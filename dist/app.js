...
var fetch = __webpack_require__(78);
...
baseUtils.hello = function () {
  return 'hello';
};

baseUtils.feedURI = function (brand) {
  return eval('`' + settings._feedURL + '`');
};

baseUtils.getResults =
/*#__PURE__*/
function () {
